    ...
    <BackgroundGradient className="rounded-[22px] w-full h-full p-4 sm:p-10 bg-white dark:bg-zinc-900">
      <div className="flex flex-col">
        ...
        <div className="flex flex-col w-full">
          <h3 className="md:text-xl text-base font-bold text-black dark:text-white mb-2 font-poppins">
            {stall.name}
          </h3>
          <div className="flex flex-col gap-2 mb-2">
            ...
            <span
              className={`font-poppins border text-[10px] md:text-xs font-bold tracking-wider px-2 py-0.5 rounded-full w-fit ${getTypeColor(
                stall.type
              )}`}
            >
              • {stall.type}
          ...
          <p className="md:text-sm text-xs text-gray-600 dark:text-gray-300 font-poppins">
            {stall.description}
          </p>
        </div>
      </div>
